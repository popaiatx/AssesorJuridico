/**
 * Conjunto inicial de LEGISLAÇÃO REAL (fontes oficiais gratuitas — Planalto) para
 * a carga do corpus do Cérebro 2. Source-agnostic: o mesmo formato serve ao
 * agregador pago no 8B. URLs são páginas consolidadas do Planalto (confira a
 * vigência na fonte ao usar).
 */
